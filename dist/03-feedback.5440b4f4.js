...
let storeData = (0, _localStorage.load)(localStorageKey) || {
    message: "",
    mail: ""
};
message.value = storeData.message;
email.value = storeData.mail;
message.addEventListener("input", (0, _lodashThrottleDefault.default)((event)=>{
    storeData.message = event.currentTarget.value;
    (0, _localStorage.save)(localStorageKey, storeData);
}), 500);
email.addEventListener("input", (0, _lodashThrottleDefault.default)((event)=>{
...
},{"./localStorage":"45bAM","lodash.throttle":"bGJVT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"45bAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
