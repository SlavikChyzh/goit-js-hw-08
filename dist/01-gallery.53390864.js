...
const imgMarkup = createGalleryItem((0, _galleryItems.galleryItems));
function createGalleryItem(items) {
    return items.reduce((acc, item)=>acc += `<a class="gallery__item" rel="noopener noreferrer" href="${item.original}">
